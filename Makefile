...
multi-darwin-386:
	GOOS=darwin GOARCH=386 go build -o ./bin/multi-darwin-386 ./cmd/multi
	@echo "Darwin 386 cross compilation done."

multi-darwin-amd64:
	GOOS=darwin GOARCH=amd64 go build -o ./bin/multi-darwin-amd64 ./cmd/multi
...
multi-linux-386:
	GOOS=linux GOARCH=386 go build -o ./bin/multi-linux-386 ./cmd/multi
	@echo "Linux 386 cross compilation done."

multi-linux-amd64:
	GOOS=linux GOARCH=amd64 go build -o ./bin/multi-linux-amd64 ./cmd/multi
...
multi-windows-386:
	GOOS=windows GOARCH=386 go build -o ./bin/multi-windows-386 ./cmd/multi
	@echo "Windows 386 cross compilation done."

multi-windows-amd64:
	GOOS=windows GOARCH=amd64 go build -o ./bin/multi-windows-amd64 ./cmd/multi
